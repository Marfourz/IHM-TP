<template>
  ...
  >
    <div
      class="flex items-center justify-between w-full text-grey-70 font-semibold text-sm border border-gray-400 rounded-lg py-2.5 px-4"
    >
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.selectedDate = this.dates[4];
      this.dateChoice = {
        start: "",
        end: "",
      };
